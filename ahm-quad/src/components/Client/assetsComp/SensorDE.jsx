    ...
    <div className="flex group">
      ...
      <div className="relative flex items-center font-semibold text-[10px] pl-4 z-20 w-[40px]">
        <div className="relative flex justify-center items-center">
          <div
            className={`${color} h-2 w-2 rounded-full -left-1 -bottom-[4px] absolute blur-[5px] ${title === "Connecting..." ? "opacity-0" : "glowbtn"}`}
          ></div>
          <div
            className={`${color} h-2 w-2 -left-1 -bottom-[4px] absolute rounded-full ${title === "Connecting..." ? "glowbtn" : ""}`}
          ></div>
          {/* Tooltip container */}
