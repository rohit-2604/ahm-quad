  ...
  return (
    <div className="flex group">
      ...
      <div className="relative flex items-center font-semibold text-[10px] pr-4 ml-1">
        <div className="relative w-[25px]">
          <div
            className={`${color} h-2 w-2 -top-[5px] rounded-full absolute blur-[5px] glowbtn left-6 ${title === "Connecting..." ? "opacity-0" : "glowbtn"}`}
          ></div>
          <div
            className={`${color} h-2 w-2 -top-[4.5px] rounded-full absolute left-6 ${title === "Connecting..." ? "glowbtn" : ""}`}
          ></div>
          {/* Tooltip container */}
