...
function Acoustics({ DataReceivedFromSensor }) {
  ...
  const ultraSoundOne = DataReceivedFromSensor?.microphone_one || 0;
  const ultrasoundTwo = DataReceivedFromSensor?.microphone_two || 0;
    ...
    <div className='bg-[#FFFFFF] mb-2  lg:min-w-[400px] md:min-w-[400px] flex flex-col rounded-md items-center justify-center pb-10 w-full'>
      <div className='flex flex-col md:flex-row lg:flex-row'>
        ...
        <div className='flex flex-col justify-center items-center'>
          <Monitor value={ultraSoundOne} name={"Mic 1"} minValue={minValueForUltrasoundOne} maxValue={maxValueForUltrasoundOne} warning={warningValueForUltrasoundOne} healthy={healthyValueForUltrasoundOne} tooltipMsg={" These thresholds are as per ISO 29821 standards or customer defined thresholds as per the requirement"}  />
        </div>

        {/* Noise Monitor */}
        <div className='flex flex-col justify-center items-center'>
          <Monitor value={ultrasoundTwo} name={"Mic 2"} minValue={minValueForUltrasoundTwo} maxValue={maxValueForUltrasoundTwo} warning={warningValueForUltrasoundTwo} healthy={healthyValueForUltrasoundTwo} tooltipMsg={" These thresholds are as per ISO 29821 standards or customer defined thresholds as per the requirement"}  />
        </div>
      </div>
  ...
  const renderInactiveState = () => (
    <div className="bg-[#FFFFFF] mb-2 w-auto min-w-[425px] flex flex-col rounded-md items-center justify-center pb-10">
      ...
      <div className="px-5 py-1 font-bold bg-[#EBEBEB] rounded-md mt-10">Acoustics (Hz)</div>
    </div>
  );
